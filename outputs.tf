...
output "cluster" {
  ...
  value = {
    ...
    default_node_iam_role_arn  = module.eks.eks_managed_node_groups["default"].iam_role_arn
    default_node_iam_role_name = module.eks.eks_managed_node_groups["default"].iam_role_name
  }
